...
if (isset($_POST['submit1']))
{
  ...
  mysqli_select_db($dbc, 'wblinc_internal');
  // $dbc = mysqli_connect('localhost', 'wblinc_internal', 'WBL@HipH0pL1ves');
  // mysqli_select_db($dbc, 'wblinc_internal');
  ...
  $user_password = md5($_POST['password']);
    ...
    if (!empty($user_username) || !empty($user_password))
    {
      ...
      $query = "SELECT * FROM wblinc_internal.User WHERE email = '".$user_username."' AND passwordHash ='".$user_password."'";
...
<footer class="footer">
  <div class="container col-sm-12">
    <p class="text-muted" style="color: #FFFFFF;">© Words Beats & Life Inc. | All Rights Reserved 2017</p>
  </div>
</footer>
