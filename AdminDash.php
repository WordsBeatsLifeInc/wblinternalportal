...
<form name="AdminDash" method="post" action="AdminDash.php">
	...
	<!--BODY CONTENT-->
		<div class="col-sm-9" style="float: right;">
			...
			<input type="submit" class="btn btn-lg btn-admin" value="Create Course" onClick="location.href='CreateCourse.php'"> <input type="submit" class="btn btn-lg btn-admin" value="Create Event" onClick="location.href='CreateEvent.php'">
			
			<div class="admingrids" style="">
					<?php
		...
		<?php
				...
				if ( isset( $_POST['ApprovedElementRequest'] ) ){
					$UpdateQuery = "UPDATE Student_Element SET elementStatus = 1 WHERE studentID = '$_POST[hiddenElement]' AND elementID = '$_POST[elementID]'";
					mysql_query($UpdateQuery, $con);
				};
		...
		while($record = mysql_fetch_array($myData)) {
			...
			echo "<td>" . "<input type=text readonly name=elementID value=". $record['elementID'] . " </td>";
